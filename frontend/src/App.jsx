    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <main className="flex-1 flex flex-col items-center w-full px-4 py-8">
        <div className="w-full max-w-6xl space-y-10">
          ...
          {/* Token Holdings Section (only if connected) */}
          {
            <section className="grid grid-cols-1 gap-6 w-full">
              <div className="bg-gray-800/40 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 shadow-xl shadow-blue-900/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <TokenDisplay tokenAddress={CONTRACT_ADDRESSES.stakerToken} />
                  <TokenDisplay tokenAddress={CONTRACT_ADDRESSES.sepoliaDAI} />
                  <TokenDisplay tokenAddress={CONTRACT_ADDRESSES.sepoliaUSDC} />
                  <TokenDisplay tokenAddress={CONTRACT_ADDRESSES.rewarderToken} />
                </div>
              </div>
            </section>
          }
          ...
          <section className="grid grid-cols-1 gap-8 w-full">
            ...
            <div className="w-full">
              {activeTab === "single" ? <StakingCard /> : <MultipleStakingCard />}
            </div>
          </section>
        </div>
      </main>
